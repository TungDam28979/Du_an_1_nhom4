...
public class HoaDonModel_All {
    ...
    public HoaDonModel_All() {
    }

    public HoaDonModel_All(int maHD, String tenKH, String sdt, BigDecimal donGia, String trangThai, Date ngayTao, String diaChi, String tenNguoiTao) {
        this.maHD = maHD;
        this.tenKH = tenKH;
        this.sdt = sdt;
        this.donGia = donGia;
